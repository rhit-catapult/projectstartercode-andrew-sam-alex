...
def main():
    ...
    tar_1 = enemy(screen, 150, 385, 50, 1, 1, "sprites/target/close/appear/spawn (44).png", 1, "sprites/target/close/shot/despawn", 19, "sprites/target/close/appear/spawn", 44, 19, -25, 8, 1)
